                ...
                <form action="#" id="formid">
                  ...
                  <div>
                    <input
                      ...
                      v-model="name"
                    />
                    <p v-if="showError && !name" class="error">
  ...
  export default {
    ...
    methods: {
      ...
      emailcheckid() {
        ...
        axios
          .post(`${process.env.VUE_APP_BACK_END_URL}/login/findid`,null, {params:{
            name: this.name,
            email: this.email,
          },
          })
          .then((res) => {
            ...
            this.$router.push({ name: 'FindIdCheck', params: { id : res.data.id , mdate : res.data.mdate }});
          }
          })
          .catch((error) => {
